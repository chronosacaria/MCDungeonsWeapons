...
public class BurstBowstringEnchantment extends RangedEnchantment {
    public BurstBowstringEnchantment(Properties properties) {
        super(properties);
    }

    //public BurstBowstringEnchantment(Rarity rarity, EnchantmentTarget enchantmentTarget, EquipmentSlot[] equipmentSlots) {
    //    super(rarity, enchantmentTarget, equipmentSlots);
    //    if (McdwCommon.CONFIG.mcdwEnchantmentsConfig.ENCHANTMENT_CONFIG.get(EnchantmentsID.BURST_BOWSTRING).mcdw$getIsEnabled()) {
