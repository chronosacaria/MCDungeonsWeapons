...
public class LeechingEnchantment extends HealingEnchantment {
    public LeechingEnchantment(Properties properties) {
        super(properties);
    }

    //public LeechingEnchantment(Rarity rarity, EnchantmentTarget enchantmentTarget, EquipmentSlot[] equipmentSlots) {
    //    super(rarity, enchantmentTarget, equipmentSlots);
    //    if (McdwCommon.CONFIG.mcdwEnchantmentsConfig.ENCHANTMENT_CONFIG.get(EnchantmentsID.LEECHING).mcdw$getIsEnabled()) {
