...
public class ShockwaveEnchantment extends AoEEnchantment {
    public ShockwaveEnchantment(Properties properties) {
        super(properties);
    }

    //public ShockwaveEnchantment(Rarity rarity, EnchantmentTarget enchantmentTarget, EquipmentSlot[] equipmentSlots) {
    //    super(rarity, enchantmentTarget, equipmentSlots);
    //    if (McdwCommon.CONFIG.mcdwEnchantmentsConfig.ENCHANTMENT_CONFIG.get(EnchantmentsID.SHOCKWAVE).mcdw$getIsEnabled()) {
