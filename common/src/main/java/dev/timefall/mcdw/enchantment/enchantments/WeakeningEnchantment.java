...
public class WeakeningEnchantment extends AoEEnchantment {
    public WeakeningEnchantment(Properties properties) {
        super(properties);
    }

    //public WeakeningEnchantment(Rarity rarity, EnchantmentTarget enchantmentTarget, EquipmentSlot[] equipmentSlots) {
    //    super(rarity, enchantmentTarget, equipmentSlots);
    //    if (McdwCommon.CONFIG.mcdwEnchantmentsConfig.ENCHANTMENT_CONFIG.get(EnchantmentsID.WEAKENING).mcdw$getIsEnabled()) {
