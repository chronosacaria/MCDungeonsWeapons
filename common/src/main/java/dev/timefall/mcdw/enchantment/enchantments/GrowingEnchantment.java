...
public class GrowingEnchantment extends RangedEnchantment {
    public GrowingEnchantment(Properties properties) {
        super(properties);
    }
    //public GrowingEnchantment(Rarity rarity, EnchantmentTarget enchantmentTarget, EquipmentSlot[] equipmentSlots) {
    //    super(rarity, enchantmentTarget, equipmentSlots);
    //    if (McdwCommon.CONFIG.mcdwEnchantmentsConfig.ENCHANTMENT_CONFIG.get(EnchantmentsID.GROWING).mcdw$getIsEnabled()) {
