...
public class JunglePoisonEnchantment extends Enchantment{
    public JunglePoisonEnchantment(Properties properties) {
        super(properties);
    }

    //public JunglePoisonEnchantment(Rarity rarity, EnchantmentTarget enchantmentTarget, EquipmentSlot[] equipmentSlots) {
    //    super(rarity, enchantmentTarget, equipmentSlots);
    //    if (McdwCommon.CONFIG.mcdwEnchantmentsConfig.ENCHANTMENT_CONFIG.get(EnchantmentsID.JUNGLE_POISON).mcdw$getIsEnabled()) {
