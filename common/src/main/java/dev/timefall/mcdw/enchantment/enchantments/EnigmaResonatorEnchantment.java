...
public class EnigmaResonatorEnchantment extends DamageBoostEnchantment {
    public EnigmaResonatorEnchantment(Properties properties) {
        super(properties);
    }
    ...
    //    if (McdwCommon.CONFIG.mcdwEnchantmentsConfig.ENCHANTMENT_CONFIG.get(EnchantmentsID.ENIGMA_RESONATOR).mcdw$getIsEnabled()) {
