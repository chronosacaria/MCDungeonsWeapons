...
/*
 * Effects Needed:
 * DropItemsEffectType? -> Not sure anything like it exists
 */

/*
 * Effects Present:
 * EntityEquipmentPredicate / EntityPropertiesLootCondition -> for potions
 */

public class DippingPoisonEnchantment extends RangedEnchantment {
    public DippingPoisonEnchantment(Properties properties) {
        super(properties);
    }
    //public DippingPoisonEnchantment(Rarity rarity, EnchantmentTarget enchantmentTarget, EquipmentSlot[] equipmentSlots) {
    //    super(rarity, enchantmentTarget, equipmentSlots);
    //    if (McdwCommon.CONFIG.mcdwEnchantmentsConfig.ENCHANTMENT_CONFIG.get(EnchantmentsID.DIPPING_POISON).mcdw$getIsEnabled()) {
