...
public class IllagersBaneEnchantment extends Enchantment {
    public IllagersBaneEnchantment(Properties properties) {
        super(properties);
    }
    //public IllagersBaneEnchantment(Rarity rarity, EnchantmentTarget enchantmentTarget, EquipmentSlot[] equipmentSlots) {
    //    super(rarity, enchantmentTarget, equipmentSlots);
    //    if (McdwCommon.CONFIG.mcdwEnchantmentsConfig.ENCHANTMENT_CONFIG.get(EnchantmentsID.ILLAGERS_BANE).mcdw$getIsEnabled()) {
