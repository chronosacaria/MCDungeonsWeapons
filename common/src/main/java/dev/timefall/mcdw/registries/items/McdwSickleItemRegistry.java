...
public class McdwSickleItemRegistry {
    ...
    public static final Identifier SICKLE_LAST_LAUGH_GOLD_ID    = ModConstants.id("sickle_last_laugh_gold");
    public static final Identifier SICKLE_LAST_LAUGH_SILVER_ID  = ModConstants.id("sickle_last_laugh_silver");
    public static final Identifier SICKLE_NIGHTMARES_BITE_ID    = ModConstants.id("sickle_nightmares_bite");
    public static final Identifier SICKLE_SICKLE_ID             = ModConstants.id("sickle_sickle");
