...
public class McdwGauntletItemRegistry {
    ...
    public static final Identifier GAUNTLET_GAUNTLET_ID     = ModConstants.id("gauntlet_gauntlet");
    public static final Identifier GAUNTLET_MAULER_ID       = ModConstants.id("gauntlet_mauler");
    public static final Identifier GAUNTLET_SOUL_FIST_ID    = ModConstants.id("gauntlet_soul_fist");
