...
public class McdwShieldItemRegistry {
    ...
    public static final Identifier SHIELD_ROYAL_GUARD_SHIELD_ID   = ModConstants.id("shield_royal_guard_shield");
    public static final Identifier SHIELD_TOWER_GUARD_SHIELD_ID   = ModConstants.id("shield_tower_guard_shield");
    public static final Identifier SHIELD_VANGUARD_SHIELD_ID      = ModConstants.id("shield_vanguard_shield");
