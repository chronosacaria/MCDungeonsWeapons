...
public class McdwStaffItemRegistry {
    ...
    public static final Identifier STAFF_BATTLESTAFF_ID           = ModConstants.id("staff_battlestaff");
    public static final Identifier STAFF_BATTLESTAFF_OF_TERROR_ID = ModConstants.id("staff_battlestaff_of_terror");
    public static final Identifier STAFF_GROWING_STAFF_ID         = ModConstants.id("staff_battlestaff_growing_staff");
