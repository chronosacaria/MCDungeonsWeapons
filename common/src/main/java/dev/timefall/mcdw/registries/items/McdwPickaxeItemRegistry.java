...
public class McdwPickaxeItemRegistry {
    ...
    public static final Identifier PICK_DIAMOND_PICKAXE_VAR_ID      = ModConstants.id("pickaxe_diamond_pickaxe_var");
    public static final Identifier PICK_HAILING_PINNACLE_ID         = ModConstants.id("pickaxe_hailing_pinnacle");
    public static final Identifier PICK_HOWLING_PICK_ID             = ModConstants.id("pickaxe_howling_pick");
    public static final Identifier PICK_MOUNTAINEER_PICK_ID         = ModConstants.id("pickaxe_mountineer_pick");
