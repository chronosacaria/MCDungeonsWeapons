...
public class McdwDoubleAxeItemRegistry {
    ...
    public static final Identifier DOUBLE_AXE_CURSED_ID         = ModConstants.id("double_axe_cursed");
    public static final Identifier DOUBLE_AXE_DOUBLE_ID         = ModConstants.id("double_axe_double");
    public static final Identifier DOUBLE_AXE_WHIRLWIND_ID      = ModConstants.id("double_axe_whirlwind");
