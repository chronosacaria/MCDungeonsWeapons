...
public class McdwCrossbowItemRegistry {
    ...
    public static final Identifier CROSSBOW_AUTO_CROSSBOW_ID              = ModConstants.id("crossbow_auto_crossbow");
    public static final Identifier CROSSBOW_AZURE_SEEKER_ID               = ModConstants.id("crossbow_azure_seeker");
    public static final Identifier CROSSBOW_BABY_CROSSBOW_ID              = ModConstants.id("crossbow_baby_crossbow");
    public static final Identifier CROSSBOW_BURST_CROSSBOW_ID             = ModConstants.id("crossbow_burst_crossbow");
    public static final Identifier CROSSBOW_BUTTERFLY_CROSSBOW_ID         = ModConstants.id("crossbow_butterfly_crossbow");
    public static final Identifier CROSSBOW_COG_CROSSBOW_ID               = ModConstants.id("crossbow_cog_crossbow");
    public static final Identifier CROSSBOW_CORRUPTED_CROSSBOW_ID         = ModConstants.id("crossbow_corrupted_crossbow");
    public static final Identifier CROSSBOW_DOOM_CROSSBOW_ID              = ModConstants.id("crossbow_doom_crossbow");
    public static final Identifier CROSSBOW_DUAL_CROSSBOW_ID              = ModConstants.id("crossbow_dual_crossbow");
    public static final Identifier CROSSBOW_EXPLODING_CROSSBOW_ID         = ModConstants.id("crossbow_exploding_crossbow");
    public static final Identifier CROSSBOW_FERAL_SOUL_CROSSBOW_ID        = ModConstants.id("crossbow_feral_soul_crossbow");
    public static final Identifier CROSSBOW_FIREBOLT_THROWER_ID           = ModConstants.id("crossbow_firebolt_thrower");
    public static final Identifier CROSSBOW_HARPOON_CROSSBOW_ID           = ModConstants.id("crossbow_harpoon_crossbow");
    public static final Identifier CROSSBOW_HARP_CROSSBOW_ID              = ModConstants.id("crossbow_harp_crossbow");
    public static final Identifier CROSSBOW_HEAVY_CROSSBOW_ID             = ModConstants.id("crossbow_heavy_crossbow");
    public static final Identifier CROSSBOW_IMPLODING_CROSSBOW_ID         = ModConstants.id("crossbow_imploding_crossbow");
    public static final Identifier CROSSBOW_LIGHTNING_HARP_CROSSBOW_ID    = ModConstants.id("crossbow_lightning_harp_crossbow");
    public static final Identifier CROSSBOW_NAUTICAL_CROSSBOW_ID          = ModConstants.id("crossbow_nautical_crossbow");
    public static final Identifier CROSSBOW_PRIDE_OF_THE_PIGLINS_ID       = ModConstants.id("crossbow_pride_of_the_piglins");
    public static final Identifier CROSSBOW_RAPID_CROSSBOW_ID             = ModConstants.id("crossbow_rapid_crossbow");
    public static final Identifier CROSSBOW_SCATTER_CROSSBOW_ID           = ModConstants.id("crossbow_scatter_crossbow");
    public static final Identifier CROSSBOW_SHADOW_CROSSBOW_ID            = ModConstants.id("crossbow_shadow_crossbow");
    public static final Identifier CROSSBOW_SLAYER_CROSSBOW_ID            = ModConstants.id("crossbow_slayer_crossbow");
    public static final Identifier CROSSBOW_SOUL_CROSSBOW_ID              = ModConstants.id("crossbow_soul_crossbow");
    public static final Identifier CROSSBOW_SOUL_HUNTER_CROSSBOW_ID       = ModConstants.id("crossbow_soul_hunter_crossbow");
    public static final Identifier CROSSBOW_SPELLBOUND_CROSSBOW_ID        = ModConstants.id("crossbow_spellbound_crossbow");
    public static final Identifier CROSSBOW_THE_SLICER_ID                 = ModConstants.id("crossbow_the_slicer");
    public static final Identifier CROSSBOW_VEILED_CROSSBOW_ID            = ModConstants.id("crossbow_veiled_crossbow");
    public static final Identifier CROSSBOW_VOIDCALLER_CROSSBOW_ID        = ModConstants.id("crossbow_voidcaller_crossbow");
