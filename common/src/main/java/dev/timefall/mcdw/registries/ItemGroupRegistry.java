...
public class ItemGroupRegistry {
    public static final RegistryKey<ItemGroup> MELEE = RegistryKey.of(RegistryKeys.ITEM_GROUP, ModConstants.id("weapons/melee"));
    public static final RegistryKey<ItemGroup> RANGED = RegistryKey.of(RegistryKeys.ITEM_GROUP, ModConstants.id("weapons/ranged"));
    public static final RegistryKey<ItemGroup> SHIELDS = RegistryKey.of(RegistryKeys.ITEM_GROUP, ModConstants.id("weapons/shields"));
    public static final RegistryKey<ItemGroup> ENCHANTMENTS = RegistryKey.of(RegistryKeys.ITEM_GROUP, ModConstants.id("enchantments"));
