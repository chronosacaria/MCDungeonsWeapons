...
public class McdwSpearItemRegistry {
    ...
    public static final Identifier SPEAR_SPEAR_ID             = ModConstants.id("spear_spear");
    public static final Identifier SPEAR_WHISPERING_SPEAR_ID  = ModConstants.id("spear_whispering_spear");
    public static final Identifier SPEAR_FORTUNE_SPEAR_ID     = ModConstants.id("spear_fortune_spear");
