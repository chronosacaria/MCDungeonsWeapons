...
public class McdwSoulDaggerItemRegistry {
    ...
    public static final Identifier SOUL_DAGGER_ETERNAL_KNIFE_ID        = ModConstants.id("soul_dagger_eternal_knife");
    public static final Identifier SOUL_DAGGER_SOUL_KNIFE_ID           = ModConstants.id("soul_dagger_soul_knife");
    public static final Identifier SOUL_DAGGER_TRUTHSEEKER_ID          = ModConstants.id("soul_dagger_truthseeker");
