...
public class McdwGlaiveItemRegistry {
    ...
    public static final Identifier GLAIVE_CACKLING_BROOM_ID     = ModConstants.id("glaive_cackling_broom");
    public static final Identifier GLAIVE_GLAIVE_ID             = ModConstants.id("glaive_glaive");
    public static final Identifier GLAIVE_GRAVE_BANE_ID         = ModConstants.id("glaive_grave_bane");
    public static final Identifier GLAIVE_VENOM_GLAIVE_ID       = ModConstants.id("glaive_venom_glaive");
