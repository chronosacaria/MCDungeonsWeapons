...
public class McdwAxeItemRegistry {
    ...
    public static final Identifier AXE_ANCHOR_ID            = ModConstants.id("axe_anchor");
    public static final Identifier AXE_HIGHLAND_ID          = ModConstants.id("axe_highland");
    public static final Identifier AXE_AXE_ID               = ModConstants.id("axe_axe");
    public static final Identifier AXE_ENCRUSTED_ANCHOR_ID  = ModConstants.id("axe_encrusted_anchor");
    public static final Identifier AXE_FIREBRAND_ID         = ModConstants.id("axe_firebrand");
