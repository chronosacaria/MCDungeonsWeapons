...
public class McdwNewLoottables {
    ...
    static List<McdwWeaponID> COMMON_LOOT_POOL = List.of(AxesID.AXE_ANCHOR, AxesID.AXE_AXE, DaggersID.DAGGER_DAGGER, DoubleAxesID.AXE_DOUBLE, GauntletsID.GAUNTLET_GAUNTLET,
    ...
    static List<McdwWeaponID> UNCOMMON_LOOT_POOL = List.of(BowsID.BOW_BONEBOW, BowsID.BOW_BUBBLE_BOW, BowsID.BOW_HUNTERS_PROMISE, BowsID.BOW_HUNTING_BOW, BowsID.BOW_MASTERS_BOW,
    ...
    static List<McdwWeaponID> RARE_LOOT_POOL = List.of(AxesID.AXE_ENCRUSTED_ANCHOR, AxesID.AXE_FIREBRAND, AxesID.AXE_HIGHLAND, BowsID.BOW_BUBBLE_BURSTER, BowsID.BOW_BURST_GALE_BOW,
    ...
    static List<McdwWeaponID> EPIC_LOOT_POOL = List.of(BowsID.BOW_ANCIENT_BOW, BowsID.BOW_HAUNTED_BOW, BowsID.BOW_LOST_SOULS, CrossbowsID.CROSSBOW_CORRUPTED_CROSSBOW,
