...
public enum CrossbowsID implements IRangedWeaponID {
    ...
    //    return switch (this) {
    //        case CROSSBOW_AUTO_CROSSBOW -> Map.of(ACCELERATE, 1, BONUS_SHOT, 1);
    ...
    //        case CROSSBOW_BABY_CROSSBOW -> Map.of(GROWING, 1);
    //        case CROSSBOW_BUTTERFLY_CROSSBOW -> Map.of(BONUS_SHOT, 1);
    //        case CROSSBOW_CORRUPTED_CROSSBOW -> Map.of(DYNAMO, 1);
    //        case CROSSBOW_DOOM_CROSSBOW -> Map.of(PUNCH, 1);
    //        case CROSSBOW_EXPLODING_CROSSBOW -> Map.of(FUSE_SHOT, 1);
    //        case CROSSBOW_FERAL_SOUL_CROSSBOW, CROSSBOW_SOUL_CROSSBOW, CROSSBOW_SOUL_HUNTER_CROSSBOW -> Map.of(ENIGMA_RESONATOR, 1);
    //        case CROSSBOW_FIREBOLT_THROWER -> Map.of(CHAIN_REACTION, 1);
    //        case CROSSBOW_HARP_CROSSBOW, CROSSBOW_SCATTER_CROSSBOW -> Map.of(MULTISHOT, 1);
    //        case CROSSBOW_IMPLODING_CROSSBOW, CROSSBOW_VOIDCALLER_CROSSBOW -> Map.of(GRAVITY, 1);
    //        case CROSSBOW_LIGHTNING_HARP_CROSSBOW -> Map.of(MULTISHOT, 1, RICOCHET, 1);
    //        case CROSSBOW_NAUTICAL_CROSSBOW, CROSSBOW_PRIDE_OF_THE_PIGLINS, CROSSBOW_THE_SLICER -> Map.of(PIERCING, 1);
    //        case CROSSBOW_SHADOW_CROSSBOW -> Map.of(SHADOW_SHOT, 1);
    //        case CROSSBOW_SLAYER_CROSSBOW -> Map.of(RICOCHET, 1);
    //        case CROSSBOW_VEILED_CROSSBOW -> Map.of(SHADOW_SHOT, 1, SHADOW_BARB, 1);
    //    };
    //}
}