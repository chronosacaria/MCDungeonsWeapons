...
public class McdwNewStatsConfig implements ConfigData {
    ...
    public McdwNewStatsConfig() {
        ...
        bowStats(materialToString(ToolMaterials.NETHERITE),14.0f, 18f, BowsID.BOW_ANCIENT_BOW);
        bowStats(materialToString(ToolMaterials.STONE),16.0f, 12f, BowsID.BOW_BONEBOW);
        bowStats(materialToString(ToolMaterials.NETHERITE),12.0f, 17f, BowsID.BOW_LOST_SOULS);
        bowStats(materialToString(ToolMaterials.IRON),20.0f, 15f, BowsID.BOW_ELITE_POWER_BOW);
        bowStats(materialToString(ToolMaterials.NETHERITE),18.0f, 16f, BowsID.BOW_HAUNTED_BOW);
        bowStats(materialToString(ToolMaterials.IRON),15.0f, 10f, BowsID.BOW_HUNTERS_PROMISE);
        bowStats(materialToString(ToolMaterials.IRON),16.0f, 11f, BowsID.BOW_HUNTING_BOW);
        bowStats(materialToString(ToolMaterials.IRON),17.0f, 10f, BowsID.BOW_MASTERS_BOW);
        bowStats(materialToString(ToolMaterials.DIAMOND),17.0f, 14f, BowsID.BOW_NOCTURNAL_BOW);
        bowStats(materialToString(ToolMaterials.IRON),20.0f, 14f, BowsID.BOW_POWER_BOW);
        bowStats(materialToString(ToolMaterials.DIAMOND),10.0f, 13f, BowsID.BOW_SABREWING);
        bowStats(materialToString(ToolMaterials.IRON),16.0f, 11f, BowsID.BOW_SNOW_BOW);
        bowStats(materialToString(ToolMaterials.IRON),14.0f, 10f, BowsID.BOW_SOUL_BOW);
        bowStats(materialToString(ToolMaterials.DIAMOND),17.0f, 13f, BowsID.BOW_GREEN_MENACE);
        bowStats(materialToString(ToolMaterials.DIAMOND),17.0f, 13f, BowsID.BOW_PINK_SCOUNDREL);
        bowStats(materialToString(ToolMaterials.DIAMOND),12.0f, 10f, BowsID.BOW_TRICKBOW);
        bowStats(materialToString(ToolMaterials.DIAMOND),12.0f, 10f, BowsID.BOW_TWIN_BOW);
        bowStats(materialToString(ToolMaterials.DIAMOND),15.0f, 13f, BowsID.BOW_WINTERS_TOUCH);
        bowStats(materialToString(ToolMaterials.DIAMOND),14.0f, 10f, BowsID.BOW_SHIVERING_BOW);
        bowStats(materialToString(ToolMaterials.DIAMOND),11.0f, 15f, BowsID.BOW_WIND_BOW);
        bowStats(materialToString(ToolMaterials.DIAMOND),11.0f, 16f, BowsID.BOW_ECHO_OF_THE_VALLEY);
        bowStats(materialToString(ToolMaterials.DIAMOND),12.0f, 16f, BowsID.BOW_BURST_GALE_BOW);
        bowStats(materialToString(ToolMaterials.IRON),15.0f, 10f, BowsID.BOW_TWISTING_VINE_BOW);
        bowStats(materialToString(ToolMaterials.IRON),15.0f, 10f, BowsID.BOW_WEEPING_VINE_BOW);
        bowStats(materialToString(ToolMaterials.IRON),15.0f, 12f, BowsID.BOW_BUBBLE_BOW);
        bowStats(materialToString(ToolMaterials.DIAMOND),15.0f, 13f, BowsID.BOW_BUBBLE_BURSTER);
        bowStats(materialToString(ToolMaterials.DIAMOND),15.0f, 15f, BowsID.BOW_VOID_BOW);
        bowStats(materialToString(ToolMaterials.NETHERITE),15.0f, 16f, BowsID.BOW_CALL_OF_THE_VOID);
        bowStats(materialToString(ToolMaterials.DIAMOND),20.0f, 14f, BowsID.BOW_PHANTOM_BOW);
        bowStats(materialToString(ToolMaterials.DIAMOND),15.0f, 12f, BowsID.BOW_WEB_BOW);

        shortBowStats(materialToString(ToolMaterials.IRON), 9.0f, 8f, ShortBowsID.BOW_SHORTBOW);
        shortBowStats(materialToString(ToolMaterials.IRON), 9.0f, 8f, ShortBowsID.BOW_LOVE_SPELL_BOW);
        shortBowStats(materialToString(ToolMaterials.IRON), 9.0f, 9f, ShortBowsID.BOW_MECHANICAL_SHORTBOW);
        shortBowStats(materialToString(ToolMaterials.IRON), 9.0f, 8f, ShortBowsID.BOW_PURPLE_STORM);

        longBowStats(materialToString(ToolMaterials.IRON), 25.0f, 17f, LongBowsID.BOW_LONGBOW);
        longBowStats(materialToString(ToolMaterials.DIAMOND), 30.0f, 19f, LongBowsID.BOW_GUARDIAN_BOW);
        longBowStats(materialToString(ToolMaterials.DIAMOND), 30.0f, 18f, LongBowsID.BOW_RED_SNAKE);
