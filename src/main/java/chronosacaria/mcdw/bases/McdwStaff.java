...
public class McdwStaff extends TridentItem {
    ...
    public McdwStaff(ToolMaterial material, float attackDamage, float attackSpeed,
                     Supplier<EntityType<SpearEntity>> typeSupplier, String id) {
        super(new Settings().group(Mcdw.WEAPONS));
