...
public class EnchantsLists {
    ...
    public static List<Enchantment> EnchantsList = List.of(EnchantsRegistry.ACCELERATE, EnchantsRegistry.AMBUSH, EnchantsRegistry.ANIMA_CONDUIT,
            ...
            EnchantsRegistry.DIPPING_POISON, EnchantsRegistry.DYNAMO, EnchantsRegistry.ECHO, EnchantsRegistry.ENIGMA_RESONATOR,
            EnchantsRegistry.EXPLODING, EnchantsRegistry.FREEZING, EnchantsRegistry.FUSE_SHOT, EnchantsRegistry.GRAVITY, EnchantsRegistry.GROWING,
