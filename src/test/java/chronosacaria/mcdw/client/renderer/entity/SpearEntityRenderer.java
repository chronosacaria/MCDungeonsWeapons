/*package chronosacaria.mcdw.client.renderer.entity;
...
public class SpearEntityRenderer extends EntityRenderer<SpearEntity> {
    ...
    @Override
    public void render(SpearEntity spear, float f, float g, MatrixStack matrixStack,
                       VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
        matrixStack.multiply(Vector3f.POSITIVE_Y.getDegreesQuaternion(MathHelper.lerp(g, spear.prevYaw, spear.yaw) - 90.0F));
        matrixStack.multiply(Vector3f.POSITIVE_Z.getDegreesQuaternion(MathHelper.lerp(g, spear.prevPitch,
                spear.pitch) + 90.0F));
        //VertexConsumer vertexConsumer = ItemRenderer.getArmorVertexConsumer(vertexConsumerProvider,
                //model.getLayer(this.getTexture(spear)), false, spear.method_23751());
